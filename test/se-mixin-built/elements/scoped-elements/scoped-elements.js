...
const defineElement = (tagName, klass) => {
  ...
  const tag = createUniqueTag(registry, tagName); // we extend it just in case the class has been defined manually
...
export const registerElement = (tagName, klass) => getFromTagsCache(klass) || defineElement(tagName, klass);